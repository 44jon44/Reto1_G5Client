...
public class SignUpControllerTest extends ApplicationTest {
     ...
     */
    @Test
    public void testF_UsuarioYaExiste() {
        clickOn("#hyperSignUP");
        clickOn("#tfFullName");
        write("username");
        clickOn("#tfUser");
     ...
     */
    @Test
    public void testG_EmailNoValido() {
        clickOn("#hyperSignUP");
        clickOn("#tfFullName");
        write("username");
        clickOn("#tfUser");
     ...
     */
    @Test
    public void testH_ContraseñaMuyCorto() {
        clickOn("#hyperSignUP");
        clickOn("#tfFullName");
        write("username");
        clickOn("#tfUser");
     ...
     */
    @Test
    public void testI_RepetirContraseñaIncorrecto() {
        clickOn("#hyperSignUP");    
        clickOn("#tfPassword");
        write("username$1");
        clickOn("#tfRepeatPassword");
 ...
 @Test
    public void testJ_ValidarEmailCorrecto() {
        clickOn("#hyperSignUP");
        clickOn("#tfEmail");
    ...
    @Test
    public void testK_ValidarEmailCorto() {
        clickOn("#hyperSignUP");
        clickOn("#tfEmail");
    ...
    @Test
    public void testL_ValidarEmailDobleArroba() {
        clickOn("#hyperSignUP");
        clickOn("#tfEmail");
